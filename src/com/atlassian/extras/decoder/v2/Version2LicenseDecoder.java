   ...
   private Properties loadLicenseConfiguration(Reader text)
   {
	 ...
	 try
     {
       ...
       if(props.containsKey("Description")) {
    	   ...
    	   props.put("MaintenanceExpiryDate","2033-12-31");
    	   props.put("LicenseExpiryDate","2033-12-31");
       }
       return props;
     }
     catch (IOException e)
...
/* Location:              E:\Software\jira\atlassian-jira\WEB-INF\atlassian-bundled-plugins\atlassian-universal-plugin-manager-plugin-2.22.9.jar!\com\atlassian\extras\decoder\v2\Version2LicenseDecoder.class
